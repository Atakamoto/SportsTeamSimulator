int aP = -20; //change to affect all players skill level (change amount added to aP for individual player changes)
int possessions = 100; //200 for standard NBA Game
Player sharksP1 = new Player("Thomas", aP); Player sharksP2 = new Player("James", aP - 5); Player sharksP3 = new Player("Nicolas", aP -10); Player sharksP4 = new Player("Jordan", aP - 10); Player sharksP5 = new Player("Alex", aP + 40);
...
Player lionsP1 = new Player("William", aP - 14); Player lionsP2 = new Player("Michael", aP - 9); Player lionsP3 = new Player("Levi", aP - 5); Player lionsP4 = new Player("Dien", aP + 3); Player lionsP5 = new Player("Matthew", aP - 10);
...
Team sharks = new Team("Sharks", sharksP1, sharksP2, sharksP3, sharksP4, sharksP5);
Team dolphins = new Team("Dolphins", dolphinsP1, dolphinsP2, dolphinsP3, dolphinsP4, dolphinsP5);
Team snakes = new Team("Snakes", snakesP1, snakesP2, snakesP3,snakesP4, snakesP5);
Team tigers = new Team("Tigers", tigersP1, tigersP2, tigersP3, tigersP4, tigersP5);
Team eagles = new Team("Eagles", eaglesP1, eaglesP2, eaglesP3, eaglesP4, eaglesP5);
Team hawks = new Team("Hawks", hawksP1, hawksP2, hawksP3, hawksP4, hawksP5);
Team rays = new Team("Rays", raysP1, raysP2, raysP3, raysP4, raysP5);
Team lions = new Team("Lions", lionsP1, lionsP2, lionsP3, lionsP4, lionsP5);
...
public void setup()
{
  ...
  delay(5000); //change how long after game the player results are displayed
